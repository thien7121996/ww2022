...
class DoanhThuSaleOnline extends Component {
    constructor (props) {
    super(props)
    this.state = {
        khammoi: [],
...
componentDidMount(){
    ...
    axios.get('/index.php/api/getallkhammoitrongngaysaleonline').then(response => {
...
{/* /tabs */}
      ...
      <div className="col-sm-12">
        <div className="white-box">
          <h3 className="box-title">DOANH THU SALE ONLINE
  </h3>
...
export default DoanhThuSaleOnline;