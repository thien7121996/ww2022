        ...
        <div className="row">
              ...
              <th  style={{    fontWeight: 'bolder',fontSize: '20px'}}>MSKH</th>
                                ...
                                {khachhanglist.map((dv, index)  => (
                                    <tr key={dv.ID}>
                                        <td className="title"><a href="#" onClick={e => e.preventDefault()}>{dv.mahoso}</a></td>
                                        <td> <img src={'./public/uploads/customer/'+dv.anhdaidien}  width='70px' height='70px'/></td>
                                        <td><Link to={'/ho-so-khach-hang/'+dv.ID} key={dv.ID} className="btn danhturieng" >{dv.hoten}</Link>
