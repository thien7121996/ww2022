...
class ViecNhan extends Component {
  constructor (props) {
    super(props)
    this.state = {
      listgiaoviec: '',
...
axios.get('/index.php/api/danhsachviecnhan/'+localStorage.getItem('userid')).then(response => {
    this.setState({
  ...
  render() {
    ...
    return (
      ...
      <div className="row App" id="lichbooking">
        ...
        <h3 className="box-title">DANH SÁCH VIỆC NHẬN
  </h3>
  <div className="row">
