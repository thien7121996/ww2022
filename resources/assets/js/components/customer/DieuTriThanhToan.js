...
class DieuTriThanhToan extends Component {
    constructor (props) {
        super(props)
    this.state = {
        khachhang: [],
...
getphieudieutrichitiet(event){
  ...
  render() {
 const { idkhachhang,phieudieutri,khachhang,chandoanlist,listchandoan } = this.state
    return (
      <div className="row">
...
<nav>
 <ul>
   ...
   <li className="tab-current"><Link to={'/lap-phieu-khach-hang/'+idkhachhang} className="sticon"><span>Chẩn đoán và lập hóa đơn</span></Link></li>
          ...
          <table className="table color-table primary-table" >
            ...
            {phieudieutri.map(cd => ( 
              <tr key={cd.id} id={"phieudieutriitem"+cd.id} data-itemcd={cd.id}>
                ...
                <td data-icd={cd.id}>{cd.ngaylapphieu}</td>
                ...
                <td className="btnaction">
                  ...
                  <button onClick={this.handleChiTietPhieuDieuTri} className="icon-list-demo btn btn-info btn-circle btn-xl" data-idphieudieutri={cd.id}>
                    <Link to={'/phieu-dieu-chi-chi-tiet/'+idkhachhang+'/'+cd.id}><i className="fa fa-external-link" data-idphieudieutri={cd.id}></i></Link>
                  </button>
          ...
          <div className="modal-body">
            <form onSubmit={this.handleCreateNewPhieuDieuTri}>
              <div className="form-group">
                <label htmlFor="recipient-name" className="control-label">Ngày lập phiếu</label>
                <input type="text" className="form-control" name="ngaylapphieu" disabled id="ngaylapphieu" value={ngayhientai} onChange={this.handleFieldChange} /> </div>
                <div className="form-group">
                    <div className="row">
      ...
      <div className="modal-dialog" role="document">
        <div className="modal-content">
          ...
          <div className="modal-body">
            ...
            <div className="form-group">
                <label htmlFor="recipient-name" className="control-label">Ngày Lập Phiếu</label>
                <input type="text" className="form-control" name="ngaylapphieu" id="updatengaylapphieu" onChange={this.handleFieldChange} /> </div>
                <div className="form-group">
                <div className="row">
                  <div className="col-md-12">
...
export default DieuTriThanhToan;