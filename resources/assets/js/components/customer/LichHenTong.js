...
import { Column, DataGrid, FilterRow, Selection, Button, HeaderFilter, GroupPanel, Scrolling, Editing, Grouping, Lookup, MasterDetail, Summary, RangeRule, RequiredRule, StringLengthRule, GroupItem, TotalItem, ValueFormat, Pager, Paging } from 'devextreme-react/data-grid';
...
else
{
 ...
 if(response.status==200)
    ...
    else
    {
      ...
      axios.get('/index.php/api/lichlamviectheothang/'+month+'/?chinhanhkh='+localStorage.getItem('userchinhanh')).then(response => {
  ...
  render() {
    ...
    return (
      <div className="row App" id="lichbooking">
            <form onSubmit={this.handleBoLocLichHen} id="boloclich" className="row col-md-12 m-b-40 hidden">
...
<div className="col-md-6">
      ...
      <div className="col-sm-12">
		...
		<Link to={'/lich-tong-theo-ngay/'} className="sticon hidden"><i className="ti-calendar lichlvdt" ></i></Link>
  ...
  <DataGrid
      ...
      >
       ...
       <Paging defaultPageSize={20} />
        ...
        <Column
          caption="Chi nhánh"
          dataField="dieutritheolich.chinhanhs.tenchinhanh"
        ...
        <Column
        caption="Mới/Cũ"
        dataField="dieutritheolich.moicu"
