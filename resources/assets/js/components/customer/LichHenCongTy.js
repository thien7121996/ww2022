...
class LichHenCongTy extends Component {
  constructor (props) {
    super(props)
    this.state = {
      events: [],
...
else
{
  ...
  axios.get('/index.php/api/infouser/'+localStorage.getItem('userid')).then(response => {
    ...
    axios.get('/index.php/api/lichlamviectheothangcongty/'+localStorage.getItem('userid')).then(response => {
        this.setState({
