...
class HoaHongTheoDirectSale extends Component {
    constructor (props) {
    super(props)
    this.state = {
        khammoi: [],
...
componentDidMount(){
 document.getElementById("loadingapp").style.display = "none";
    axios.get('/index.php/api/getallkhammoidirectsale').then(response => {
...
{/* /tabs */}
      ...
      <div className="col-sm-12">
        <div className="white-box">
          <h3 className="box-title">DANH SÁCH HOA HỒNG DIRECT SALE
  </h3>
...
export default HoaHongTheoDirectSale;