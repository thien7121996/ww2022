...
class HoaHongTheoSaleOnline extends Component {
    constructor (props) {
    super(props)
    this.state = {
        khammoi: [],
...
componentDidMount(){
 document.getElementById("loadingapp").style.display = "none";
    axios.get('/index.php/api/getallkhammoisaleonline').then(response => {
...
{/* /tabs */}
      ...
      <div className="col-sm-12">
        <div className="white-box">
          <h3 className="box-title">DANH SÁCH HOA HỒNG SALE ONLINE
  </h3>
...
export default HoaHongTheoSaleOnline;