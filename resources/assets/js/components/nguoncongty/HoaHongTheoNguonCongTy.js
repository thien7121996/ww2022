...
class HoaHongTheoNguonCongTy extends Component {
    constructor (props) {
    super(props)
    this.state = {
        khammoi: [],
...
componentDidMount(){
 document.getElementById("loadingapp").style.display = "block";
    axios.get('/index.php/api/getallkhammoitheonguoncongty/'+localStorage.getItem('userid')).then(response => {
...
{/* /tabs */}
      ...
      <div className="col-sm-12">
        <div className="white-box">
          <h3 className="box-title">DANH SÁCH HOA HỒNG THEO CÔNG TY
  </h3>
...
export default HoaHongTheoNguonCongTy;