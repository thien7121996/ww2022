...
class NhacNhoHoanThanh extends Component {
    constructor (props) {
    super(props)
    this.state = {
        khammoi: [],
	...
	this.changeTrangThai7Ngay = this.changeTrangThai7Ngay.bind(this)
	this.changeTrangThai30Ngay = this.changeTrangThai30Ngay.bind(this)
	this.changeTrangThai90Ngay = this.changeTrangThai90Ngay.bind(this)
	this.changeNote = this.changeNote.bind(this)
  }
...
componentDidMount(){
  ...
  document.getElementById("loadingapp").style.display = "block";
    axios.get('/index.php/api/getallkhammoicskhnhacnho').then(response => {
...
changeTrangThai7Ngay(event) {
  event.preventDefault()
  let idkm=event.target.attributes.getNamedItem('data-icd').value

  
   axios.post('/index.php/api/capnhat7ngay/'+idkm)
   .then(response => {
    axios.get('/index.php/api/getallkhammoicskhnhacnho/').then(response => {
      this.setState({
       khammoi: response.data
 ...
 changeTrangThai30Ngay(event) {
  event.preventDefault()
  let idkm=event.target.attributes.getNamedItem('data-icd').value

  
   axios.post('/index.php/api/capnhat30ngay/'+idkm)
   .then(response => {
    axios.get('/index.php/api/getallkhammoicskhnhacnho/').then(response => {
      this.setState({
       khammoi: response.data
 ...
 changeTrangThai90Ngay(event) {
  event.preventDefault()
  let idkm=event.target.attributes.getNamedItem('data-icd').value

  
   axios.post('/index.php/api/capnhat90ngay/'+idkm)
   .then(response => {
    axios.get('/index.php/api/getallkhammoicskhnhacnho/').then(response => {
      this.setState({
       khammoi: response.data
...
handleReset(event)
  {
    document.querySelector("input[name='ngaythanhtoan']").value=""
        ...
        <div className="">
          <table className="table-bordered table-hover table color-table primary-table" >
            ...
            <p>
				...
				<td>{moment(cd.ngayhoanthanh).format("DD-MM-YYYY")}</td>
				<td>{cd.thoigiantukhihoanthanh+1}</td>
				<td data-icd={cd.id}>
				{(() => {
					if(cd.trangthai7ngay==1)
					{
						return(
						<div>
						{cd.thoigiantukhihoanthanh>5 ?  <button type="button" data-icd={cd.id}  class="btn btn-success btn-circle"><i class="fa fa-check" data-icd={cd.id}></i></button> : ''}
						</div>
					...
					else
					{
						return(
						<div>
						{cd.thoigiantukhihoanthanh>5 ?  <button type="button" data-icd={cd.id} onClick={this.changeTrangThai7Ngay} class="btn btn-default btn-circle"><i data-icd={cd.id} class="fa fa-check"></i></button> : ''}
						</div>
				...
				<td data-icd={cd.id}>
				{(() => {
					if(cd.trangthai30ngay==1)
					{
						return(
						<div>
						{cd.thoigiantukhihoanthanh>29 ?  <button type="button" data-icd={cd.id} class="btn btn-success btn-circle"><i data-icd={cd.id} class="fa fa-check"></i></button> : ''}
						</div>
					...
					else
					{
						return(
						<div>
						{cd.thoigiantukhihoanthanh>29 ?  <button type="button" data-icd={cd.id} onClick={this.changeTrangThai30Ngay} class="btn btn-default btn-circle"><i data-icd={cd.id} class="fa fa-check"></i></button> : ''}
						</div>
				...
				<td data-icd={cd.id}>
				{(() => {
					if(cd.trangthai90ngay==1)
					{
						return(
						<div>
						{cd.thoigiantukhihoanthanh>89 ?  <button type="button" data-icd={cd.id} onClick={this.changeTrangThai90Ngay} class="btn btn-success btn-circle"><i data-icd={cd.id} class="fa fa-check"></i></button> : ''}
						</div>
					...
					else
					{
						return(
						<div>
						{cd.thoigiantukhihoanthanh>89 ?  <button type="button" data-icd={cd.id} onClick={this.changeTrangThai90Ngay} class="btn btn-default btn-circle"><i data-icd={cd.id} class="fa fa-check"></i></button> : ''}
						</div>
...
export default NhacNhoHoanThanh;