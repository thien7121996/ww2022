...
class DoanhThuDirectSale extends Component {
    constructor (props) {
    super(props)
    this.state = {
        khammoi: [],
...
componentDidMount(){
 document.getElementById("loadingapp").style.display = "block";
    axios.get('/index.php/api/getallkhammoitrongngaydirectsale').then(response => {
...
{/* /tabs */}
      ...
      <div className="col-sm-12">
        <div className="white-box">
          <h3 className="box-title">DOANH THU DIRECT SALE
  </h3>
    ...
    <div className="row">
      ...
      >
        ...
        <Column
        caption="Direct sale"
          dataField="khammoi.salesoffline.name"
...
export default DoanhThuDirectSale;